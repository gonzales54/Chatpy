  ...
  return (
    <>
      <div className="h-screen w-full flex flex-col">
        <div className="mb-6 px-6 py-3 flex items-center justify-between border-b border-gray-300">
        ...
        <div>
          ...
          <ul>
            <li>
              <Link href="/" className="px-6 py-2 flex">
                <p className="mr-4">
                  <Image
                    src={ProfileImage}
                    alt="SignIn Icon"
        ...
        <ul className="mt-auto px-6 py-2 flex justify-center items-center border-t border-gray-300">
          <li className="mr-8">
            <svg xmlns="http://www.w3.org/2000/svg" fill={router.asPath === '/id' ? 'text-gray-800' : ''} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
